...
description: "20+ years as a solutions architect and data engineer. I specialize in production AI systems that ship: RAG, evals, search and the data platforms underneath them."
include-in-header:
  - text: |
      <style>
      main.content hr {
