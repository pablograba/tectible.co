...
Long-term engagements (up to 2 years) with mid-market companies and venture-backed startups.
...
- **Legal SaaS (Spain):** Grounded answers over country law, without a cleaned corpus or a custom LLM. Built an agentic RAG chatbot with automated law-ingestion pipelines and citation-faithful answers. **99% response accuracy**, human review down to **1%**, time to answer cut ~**90%**.
